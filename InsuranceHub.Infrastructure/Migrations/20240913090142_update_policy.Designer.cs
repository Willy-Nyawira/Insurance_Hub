...
namespace InsuranceHub.Infrastructure.Migrations
{
    ...
    [Migration("20240913090142_update_policy")]
    partial class update_policy
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InsuranceHub.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7012fa65-067e-4989-865c-8f1e4f3af222"),
                            RoleType = 0
                        },
                        new
                        {
                            Id = new Guid("47323ea7-00dd-4e98-9842-a74b8089d26d"),
                            RoleType = 1
                        },
                        new
                        {
                            Id = new Guid("3f3d4cfa-6384-4252-a7f8-0a07f5046cde"),
                            RoleType = 2
                        });
                });
